...
drop table tblResume;
drop sequence seqResume;

drop table tblStudent;
drop sequence seqStudent;

drop table tblAllotment;
drop sequence seqAllotment;

drop table tblOpenSubject;
drop sequence seqOpenSubject;
...
CREATE TABLE tblQnABoard ( 
    ...
    tblAnswer_id NUMBER REFERENCES tblQuestion(id) NULL
);
