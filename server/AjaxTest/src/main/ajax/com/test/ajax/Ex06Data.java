...
//		ex06data.do?type=1
		...
		/*
		 * AjaxDAO dao = new AjaxDAO(); ArrayList<UserDTO> list = dao.listUser();
		 * 
...
//		JSONObject > JSON Object를 저장하는 클래스
//		JSONArray > JSON Array를 저장하는 클래스
...
//			}
		 ...
		 * 
		 * obj.put("question", "제목입니다."); obj.put("name", "홍길동"); obj.put("age", 20);
		 * 
		 ...
		 * 
		 * for (UserDTO dto: list) { // UserDTO > JSONObject JSONObject obj = new
		 * JSONObject(); obj.put("id", dto.getId()); obj.put("pw", dto.getPw());
		 * obj.put("name", dto.getName()); obj.put("lv", dto.getLv());
		 * 
		 * arr.add(obj); }
		 * 
	...
	private void m7(HttpServletRequest req, HttpServletResponse resp) throws IOException {
//		JSON 반환 + 다중값 + JSON simple
...
//		JSON 반환 + 다중값
		/*
		 * hong,1111,홍길동,1 dog,1111,강아지,1 cat,1111,고양이,2 [ { "id": "hong", "pw": "1111",
		 * "name": "홍길동", "lv": "1" }, "id": "hong", "pw": "1111", "name": "홍길동", "lv":
		 * "1" } ]
		 */
...
//		JSON 반환 + 단일값
		 ...
		 * 
		 * 1. key값에도 따옴표를 붙여야 함 2. 쌍따옴표 사용 { "name": "홍길동", "age": 20 }
		 * 
		 * { "question": "제목" }
		 */
...
//		XML 반환 + 다중값
		...
		/*
		 * <?xml version="1.0" encoding="UTF-8"?> <users> <user> <id>hong</id>
		 * <pw>1111</pw> <name>홍길동</name> <lv>1</lv> </user> <user> <id>dog</id>
		 * <pw>1111</pw> <name>강아지</name> <lv>1</lv> </user> <user> <id>cat</id>
		 * <pw>1111</pw> <name>고양이</name> <lv>2</lv> </user> </users>
		 */
...
//		XML 반환 + 단일값
		...
		/*
		 * <?xml version="1.0" encoding="UTF-8"?> <- 물음표 앞에 띄우면 에러가 남 <question>설문
		 * 제목</question>
		 * 
		 */
...
//		텍스트 반환 + 다중값
		/*
		 * hong,111,홍길동,1 dog,1111,강아지,1 cat,1111,고양이,2
		 */
		AjaxDAO dao = new AjaxDAO();
