...
//		Ex01.java
		 ...
		 * 4. JPA
		 * 
		 * JDBC Driver 설치 > JDBC Library를 보통 JDBC Driver 라고 칭함
		 * - JDBC Library(*.jar)
		 * - DBMS별로 다르다. > 각 DB 제조사 홈페이지에서 제공
		 * - ojdbcXXX.jar
		 * - 오라클이 설치되어있다면 오라클폴더에 jdbc가 넣어져 있음
		 ...
		 * 
		 * 6. Listener(OracleXETNListener) 중단
		 * - Connection refused: connect
		 * 
		 * 7. Oracle(OracleServiceXE) 중단
		 * - Listener refused the connection with the following error:
		 * 	ORA-12505, TNS:listener does not currently know of SID given in connect descriptor
		 * 
		 * 8. ojdbc6.jar 안가져옴
