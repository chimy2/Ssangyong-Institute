...
<body>
	...
	<div><a href="ex08_ok.jsp?">그냥 페이지 이동하기</a></div>
	<!-- 대부분 사용하는 방식 -->
	<div><a href="ex08_ok.jsp?name=강아지&age=3">데이터와 함께 페이지 이동하기</a></div>
	<div><a href="ex08_ok.jsp?" id="a1">자바 스크립트로 바꾸고 페이지 이동하기</a></div>
	
	<div><input type="submit" value="보내기" id="btn1"></div>
